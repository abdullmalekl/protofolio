...
function App() {
    ...
    return ( <
        ...
        Abdulmalik khurwat <
        /p> <
        p className = "typed-text" > { typedText } < span className = "cursor" > | < /span> <
        /p> <
        ...
        <
        h1 id = 'ce rt'
        className = "text-2xl font-bold text-center py-8" > Certifications < /h1> <
        Certifications / >
        <
        /div> <
        ...
        <
        h2 id = 'cert'
        className = "section-title" > projects < /h2> <
        section id = "projects"
        className = "my-12 px-4 md:px-12" >
        <
        ...
        <
        source src = { `${process.env.PUBLIC_URL}/videos/myproject.mp4` }
        type = "video/mp4" / >
        <
