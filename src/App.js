...
import ds from './components/images/veeam.png';
                ...
                <div className="popular-section">
                    ...
                    <div className="grid-container">
                        {items.map((item,index)=>(
                            <a key={index} href={item.url} target="_blank" rel="noopener noreferrer" className="card transition-transform hover:scale-105">
                ...
                <div className='bg-gray-100'>
                    ...
                    <section id="projects" className="my-12 px-4 md:px-12">
                        ...
                        <h2 className="video-description">
                            E-Tech is a technical educational platform focused on the Internet of Things (IoT). It offers training content and practical projects,<br/>
                            along with an integrated cloud environment for real-time device connectivity and control via WebSocket
                        </h2>
                        <div className="flex justify-center">
                            <div className="w-full max-w-3xl">
                                <video controls autoPlay muted loop playsInline className="w-full h-auto rounded-xl shadow-lg">
